...
class MarginData(KucoinBaseRestApi):
    ...
    def get_isolated_margin_config(self):
        """
    ...
    def get_isolated_margin_account(self, **kwargs):
        """
        https://docs.kucoin.com/#query-isolated-margin-account-info
        :param kwargs: [Optional] balanceCurrency
        :return:
        {
            "code":"200000",
            "data": {
    ...
    def get_isolated_borrow_order(self, **kwargs):
        """
    ...
    def get_isolated_repayment_record(self, **kwargs):
        """
        https://docs.kucoin.com/#query-outstanding-repayment-records
        :param kwargs: [Optional] symbol, currency, currentPage, pageSize
        :return:
    ...
    def quick_isolated_repayment(self, symbol, currency, sequence, size):
        """
    ...
    def repay_single_isolated_order(self, symbol, currency, tradeId, size):
        """
        https://docs.kucoin.com/#repay-a-single-order
        :param currency: currency (Mandatory)
        :type: str
